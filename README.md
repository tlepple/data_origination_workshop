...
The setup script will build and install our `Data Origination Platform` onto a single linux instances.  It installs a data generating application, a local SQL database (PostgreSQL), a Red Panda instance and a stand-alone Kafka Connect instance and configure them all to work together.   
