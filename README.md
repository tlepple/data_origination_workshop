...
## Objective:
  *  To evaluate Red Panda and Kafka Connect and setup a data origination system that streams events to this platform.  In an upcoming workshop we will integrate this data and stream to Apache Iceberg.   Here is a link to my [Apache Iceberg Integration Workshop](https://github.com/tlepple/iceberg-intro-workshop) that was built earlier. 
---
